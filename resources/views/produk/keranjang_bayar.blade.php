                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->penawaran_produk == null)
                                            @if ($item->diskon_produk == null || $item->diskon_produk == 0)
                                            {{ 'Rp ' . number_format(($item->harga_produk * $item->stok_produk), 0, ',', '.') }}
                                            @else
