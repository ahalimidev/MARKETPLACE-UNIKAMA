                        ...
                        <tbody>
                            @foreach ($hasil as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn text-info" style="border-radius: 10px;">Bayar Semua</button>
                                    </td>
                                    ...
                                    <tr class="cartpage">
                                        ...
                                        <td class="product-col">
                                            <div class="product">
                                                ...
                                                <h3 class="product-title">
                                                    ...
                                                    <p onclick="window.location='{{ route('toko', $item_ok['id_toko_penjual']) }}'">
                                                        {{ $item_ok['nama_toko'] }}</p>
                                        ...
                                        <td class="total-col">
                                            <p id="total_harga">
                                                ...
                                                @else
                                                {{ 'Rp ' . number_format($item_ok['penawaran_produk'], 0, ',', '.') }}
                                                @endif
                                            </p>
                                        </td>
