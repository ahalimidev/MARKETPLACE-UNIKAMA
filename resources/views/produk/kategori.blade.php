...
<div class="container mt-2">
    <div class="cat-blocks-container">
        <div class="row">
            @foreach ($kategori_sub as $item)
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="{{ route('kategorisub', ['kategori' =>$nama,'nama'=>$item->nama_sub_kategori,'id'=>$item->id_sub_kategori]) }}" class="cat-block">
                        <figure>
                            <span>
                                <img src="{{'https://cdn.pixabay.com/photo/2012/04/14/16/19/'.$item->foto_sub_kategori}}" width="60" height="60" alt="Category image">
                            </span>
                        </figure>

                        <h3 class="cat-block-title">{{$item->nama_sub_kategori}}</h3><!-- End .cat-block-title -->
                    </a>
                </div>
            @endforeach
        </div>
